...
//            throw "KaraokeLineCanvas constructor:karaokeline(RubyKaraokeLyricsLine) is invalid.";
        ...
        this.canvas.width = x + ((ruby_x < 0) ? -ruby_x : 0) + outline / 2;
        this.canvas.height = (fontsize + rubyheight) * 1.1 + outline + rubyoutline;
        ctx.textBaseline = "top";
    ...
    Draw(time)
    {
        ...
        if (this.karaokeline.start_time < 0)
        {
